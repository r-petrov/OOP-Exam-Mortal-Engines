namespace MortalEngines.Common
{
    public class OutputMessages
    {
        ...
        public const string MachineNameCannotBeNullOrEmpty = "Machine name cannot be null or empty.";

        public const string PilotNameCannotBeNullOrEmpty = "Pilot name cannot be null or empty string.";

        public const string NullMachineCannotBeAdded = "Null machine cannot be added to the pilot.";

        public const string ValueCannotBeNull = "{0} cannot be null.";

        public const string ValueCannotBeNegative = "{0} cannot be less than 0.";
    }
}